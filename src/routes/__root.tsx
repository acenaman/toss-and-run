...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "/public/logo_transparent.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "/public/logo_transparent.png" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "manifest", href: "/manifest.webmanifest" },
      // 👇 FIX: Dropped '/public' from the path so it reads directly from root root domain
      { rel: 'icon', href: '/public/favicon.ico', type: 'image/png' },
      { rel: "apple-touch-icon", href: "/public/logo_transparent.png" },
    ],
  }),
